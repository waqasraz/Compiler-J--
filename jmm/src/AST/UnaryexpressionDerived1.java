...
public class UnaryexpressionDerived1 extends Unaryexpression {

    private Unaryexpression unaryexpression;

    public UnaryexpressionDerived1 (Unaryexpression unaryexpression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("UnaryexpressionDerived1(\n");
