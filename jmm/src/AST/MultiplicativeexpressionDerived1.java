...
public class MultiplicativeexpressionDerived1 extends Multiplicativeexpression {

    private Unaryexpression unaryexpression;

    public MultiplicativeexpressionDerived1 (Unaryexpression unaryexpression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiplicativeexpressionDerived1(\n");
