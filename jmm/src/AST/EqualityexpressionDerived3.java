...
public class EqualityexpressionDerived3 extends Equalityexpression {

    private Equalityexpression equalityexpression;
    private Relationalexpression relationalexpression;

    public EqualityexpressionDerived3 (Equalityexpression equalityexpression, Relationalexpression relationalexpression) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("EqualityexpressionDerived3(\n");
